...
public class Requisicoes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btAprovar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/Imagens/icones/Aprovar.png"))); // NOI18N
        btAprovar.setText("Aprovar");
        btAprovar.setDisabledIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/Imagens/icones_desabilitados/aprovar.png"))); // NOI18N
        btAprovar.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        btAprovar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btAprovarActionPerformed(evt);
            }
        });
        getContentPane().add(btAprovar);
        btAprovar.setBounds(370, 10, 110, 41);
    ...
    private void btNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btNovoActionPerformed
        Requisicao telaRequisicao = new Requisicao();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Requisicoes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
